...
return static function (RoutingConfigurator $routes): void {
    $routes->add('congregation_manager_admin_dashboard', '/dashboard')
        ->controller(['congregation_manager_admin.controller.dashboard', 'index'])
        ->methods(['GET'])
    ;

    $routes->add('congregation_manager_admin_profile_update', '/profile/update')
        ->controller(['congregation_manager_admin.controller.profile', 'update'])
        ->methods(['GET', 'POST'])
    ;

    $routes->add('congregation_manager_admin_change_password', '/password/update')
