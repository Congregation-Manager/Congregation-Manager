 ...
 */
final class Version20220410133708 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Add province table.';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE province (id INT NOT NULL, congregation_id INT NOT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
