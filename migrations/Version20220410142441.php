 ...
 */
final class Version20220410142441 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Add territory table.';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE territory (id INT NOT NULL, congregation_id INT NOT NULL, area_id INT NOT NULL, name VARCHAR(255) NOT NULL, description TEXT DEFAULT NULL, PRIMARY KEY(id))');
